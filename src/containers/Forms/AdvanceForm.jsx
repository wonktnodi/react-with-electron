...
class AdvancedForm extends PureComponent {
  ...
  resizeFooterToolbar = () => {
    ...
    const drawHandle = document.querySelectorAll('.drawer-handle')[0];
  ...
  render() {
    ...
    const getErrorInfo = () => {
      ...
      const errorList = Object.keys(errors).map(key => {
        ...
        return (
          <li key={key} className={styles.errorListItem} onClick={() => scrollToField(key)} role="presentation">
